...
eric = Human.new(name: "Eric", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
harris = Human.new(name: "Harris", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
nico = Human.new(name: "Nico", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
tiffany = Human.new(name: "Tiffany", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
lodi = Human.new(name: "Lodi", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
bence = Human.new(name: "Bence", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
sharon = Human.new(name: "Sharon", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
mathieu = Human.new(name: "Mathieu", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
...
sy = Human.new(name: "Sy", description: "play with you all day", address: Faker::Address.full_address, rate: rand(1..10), user: petuser3 )
